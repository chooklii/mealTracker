			...
			{/*Not displayed on mobile*/}
				<nav id="nav">
					<ul>
						...
						<li><Link to="/recommendations">Empfehlung</Link></li>
			...
			{/*Mobile Menu*/}
				...
				<div id="mobileMenu">
					<ul>
						...
						<li className="mobileMenuPoint" onClick={() => this.changeMenu()}><Link className="mobileMenuLink" to="/recommendations">Empfehlung</Link></li>
